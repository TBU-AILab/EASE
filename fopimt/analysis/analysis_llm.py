...
class AnalysisLLM(Analysis):
    ...
    def get_parameters(cls) -> dict[str, Parameter]:
        ...
        return {
            "llm_prompt": Parameter(
                short_name="llm_prompt",
    ...
    def _init_params(self):
        ...
        self._llm_prompt = self.parameters.get(
            "llm_prompt", self.get_parameters().get("llm_prompt").default
        )
    ...
    def evaluate_analysis(self, solution: Solution) -> None:
        ...
        if "image" in solution.get_tags()["output"]:
            msg = Message(
                role=self._llmconnector.get_role_user(), message=self._llm_prompt
            )
